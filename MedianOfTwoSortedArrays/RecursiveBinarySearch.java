...
public class RecursiveBinarySearch {
    ...
    public int solve(int[] A, int[] B, int k, int aStart, int aEnd, int bStart, int bEnd) {
        ...
        // its elements, so just return the corresponding element in the other array.
        ...
        if (aIndex + bIndex < k) {
            ...
            if (aValue > bValue) { return solve(A, B, k, aStart, aEnd, bIndex + 1, bEnd); }
            else { return solve(A, B, k, aIndex + 1, aEnd, bStart, bEnd); }
        ...
        // Otherwise, remove the larger right half
            ...
            if (aValue > bValue) { return solve(A, B, k, aStart, aIndex - 1, bStart, bEnd); }
            else { return solve(A, B, k, aStart, aEnd, bStart, bIndex - 1); }
